...
namespace InfernalEclipseWeaponsDLC.Content.Buffs
{
    public class LimbBurn : ModBuff
    {
        public override void SetStaticDefaults()
        {
            ...
            {
                CalamityHelper.SetDebuffData(Type, LimbBurnCalamity.LimbBurnDebuffData);
            }
        }
    ...
    public class LimbBurnCalamity : GlobalBuff
    {
        public static DebuffData LimbBurnDebuffData = new DebuffData()
        {
            EnemyLostRegen = 100f,
            HeatDebuffScaling = 1,
        ...
        {
            if (type == ModContent.BuffType<LimbBurn>())
            {
                if (Utils.NextBool(Main.rand, 4))
                {
